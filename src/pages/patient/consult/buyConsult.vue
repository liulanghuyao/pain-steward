<template>
  <div class="wrap">
    <mo-content>
      ...
      <ll-box title="病情描述">
        <textarea class="textarea" placeholder="请您详细提交需解决的关键问题，简要提供相关病史资料及主要检查结果，以便医生更加准确分析您的病情。"></textarea>
      </ll-box>
      <ll-box title="病情图片">
        <van-uploader class="upload" v-model="fileList" multiple="" :max-count="4" />
...
<script>
  ...
  export default {
    ...
    methods: {
      buy() {
        this.$router.push('/patient/consult/payConsult');
      }
    }
  }
</script>
